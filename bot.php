      ...
      $accounts = json_decode(file_get_contents('accounts.json'),1);
			if(isset($update->message)){
              ...
              $bot->sendphoto([ 'chat_id'=>$chatId,
                  'photo'=>"https://t.me/htlrwa",
                   'caption'=>'𓊈 𝑊𝐸𝐿𝐿𝐶𝑀𝐸 𓊉 𓁹 التفعيل بواسطة @IE0N3BOT',
                  'reply_markup'=>json_encode([
                      'inline_keyboard'=>[
                          [['text'=>'➕ اضافه حسابات وهميه ➕','callback_data'=>'login'],['text'=>'➖صفحه التحكم ➖','callback_data'=>'backakil']],
                       [['text'=>"قناتي ✔ ", 'url'=>"https://t.me/htlrwa"],['text'=>"المطور ➿ ", 'url'=>"https://t.me/IE0N3BOT"]],
          	...
          	if($config['mode'] != null){
          		...
          		if($mode == 'addL'){
          		  ...
          		  if(is_numeric($text)){
                      ...
                      'chat_id'=>$chatId,
                      'message_id'=>$mid,
                      'text'=>"ألتـح ـك بـل بـؤتـ @IE0N3BOT",
                  'reply_markup'=>json_encode([
                      'inline_keyboard'=>[
                          ...
                          [['text'=>' قناتي❗','url'=>'t.me/htlrwa'],['text'=>'المطور❔','url'=>'t.me/IE0N3BOT']],
                      ]
                  ])
                  ]);
          		    $config['mode'] = null;
...
اضغط في الاسفل لمراسله المطور 👇",
                								...
                								'reply_markup'=>json_encode([
                								          ...
                								          'inline_keyboard'=>[
                								                   ...
                								                   [['text'=>'اضغط لمراسله المطور 🗣','url'=>'t.me/IE0N3BOT']],
     ...
     $bot->sendMessage([
                      ...
                      'text'=>" تـح كمـ بـل بـؤتـ @IE0N3BOT  ",
                  'reply_markup'=>json_encode([
                      'inline_keyboard'=>[
                          [['text'=>'قناتي','url'=>'t.me/htlrwa'],['text'=>'تواصل','url'=>'t.me/IE0N3BOT']],
                           [['text'=>'لشراء الببوت تواضل مع','url'=>'t.me/IE0N3BOT']],
                           [['text'=>'قناة صاحب البوت','callback_data'=>'akilf'],['text'=>'رجوع','callback_data'=>'hback']],
